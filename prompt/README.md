...
When we raise money for startups on ABCPlatform, there is always a target amount that we're trying to 
...
Suppose we have a group of investors on ABCPlatform who invest in all deals that they see. Each of the
